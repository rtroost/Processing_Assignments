...
public class Opdracht_1_3 extends PApplet {
...
public void drawAreaChart(int[] coords, int[] size, int[] xValues, int[] yValues, int[][] dataValues, String[] dataLabels, int[][] dataColours)
{
...
public float drawAxisX(int[] coords, int size, int valueStart, int valueEnd, int valueStep)
{
	String prefix = "";
	String suffix = "";
...
public void drawLabels(int[] coords, int step, String[] labels, int[][] colours)
{
    ...
    static public void main(String args[]) {
        PApplet.main(new String[] { "--bgcolor=#ECE9D8", "Opdracht_1_3" });
    }
}
